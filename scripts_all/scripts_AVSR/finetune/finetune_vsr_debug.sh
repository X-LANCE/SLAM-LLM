...
output_dir=/nfs/yangguanrou.ygr/vicuna-7b-v1.5-finetune-vsr-20230122-debug
...
--metric acc \
--avsr_dataset.modal VO \
--model_config.modal VO \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-vsr-20230116.log" \
--use_wandb \
--wandb_dir $output_dir \
--wandb_entity_name yanghaha \
--wandb_project_name slam-llm \
--wandb_exp_name vicuna-7b-v1.5-finetune-vsr-20230116 \
--log_interval 5 \
...
--avsr_dataset.modal VO \
--model_config.modal VO \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-vsr-20230122-debug" \
--use_wandb \
--wandb_dir $output_dir \
--wandb_entity_name yanghaha \
--wandb_project_name slam-llm \
--wandb_exp_name vicuna-7b-v1.5-finetune-vsr-20230122 \
--log_interval 5 \
