...
output_dir=/nfs/yangguanrou.ygr/vicuna-7b-v1.5-finetune-sotaavsr-20230119
...
--metric acc \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-sotaavsr-20230119.log" \
--modality "audiovisual" \
--use_wandb \
--wandb_dir $output_dir \
--wandb_entity_name yanghaha \
--wandb_project_name slam-llm \
--wandb_exp_name vicuna-7b-v1.5-finetune-sotaavsr-20230119 \
--log_interval 5 \
...
--output_dir $output_dir \
--metric acc \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-sotaavsr-20230119_continue.log" \
--modality "audiovisual" \
--use_wandb \
--wandb_dir $output_dir \
--wandb_entity_name yanghaha \
...
--wandb_exp_name vicuna-7b-v1.5-finetune-sotaavsr-20230119 \
--log_interval 5 \
--ckpt_path "/nfs/yangguanrou.ygr/vicuna-7b-v1.5-finetune-sotaavsr-20230119/avsr/25/model.pt" \
