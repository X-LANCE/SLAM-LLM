...
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-asr-20230116_continue.log" \
--use_wandb \
--wandb_dir $output_dir \
--wandb_entity_name yanghaha \
--wandb_project_name slam-llm \
--wandb_exp_name vicuna-7b-v1.5-finetune-asr-20230116 \
--log_interval 5 \
...
--wandb_exp_name vicuna-7b-v1.5-finetune-asr-20230116 \
--log_interval 5 \
--ckpt_path "/nfs/yangguanrou.ygr/vicuna-7b-v1.5-finetune-asr-20230116/avsr/4/model.pt" \
