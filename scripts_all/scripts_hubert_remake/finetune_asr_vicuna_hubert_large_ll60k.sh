...
output_dir=/nfs/yangguanrou.ygr/vicuna-7b-v1.5-hubert_large_ll60k-0129
...
++traidn_config.batch_size_training=6 \
...
++log_config.wandb_exp_name=vicuna-7b-v1.5-hubert_large_ll60k-0129 \
