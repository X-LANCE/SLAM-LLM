...
do
    ...
    ++decode_log=$ckpt_path/decode_log_test_other_beam4_repetition_penalty1_length_penalty$length_penalty \
    ++train_config.freeze_encoder=true \
    ++train_config.freeze_llm=true \
    ++train_config.length_penalty=$length_penalty
done