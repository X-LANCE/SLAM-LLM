...
speech_encoder_path=/nfs/yangguanrou.ygr/hubert_ckpt/hubert_xtralarge_ll60k.pt

llm_path=/nfs/maziyang.mzy/models/vicuna-7b-v1.5

output_dir=/nfs/yangguanrou.ygr/experiments_hubert/vicuna-7b-v1.5-hubert_xtralarge_ll60k-0129
ckpt_path=$output_dir/asr/10594
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1_bs1
