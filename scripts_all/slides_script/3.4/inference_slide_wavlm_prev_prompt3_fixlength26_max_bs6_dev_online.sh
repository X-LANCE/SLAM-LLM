...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-wavlm_prev_prompt3_fix26_max
ckpt_path=$output_dir/asr/7680

val_data_path=/nfs/yangguanrou.ygr/slidespeech/dev_oracle_v1/
decode_log=$ckpt_path/decode_log_dev_clean_beam4_repetition_penalty1_online_bs8
...
++dataset_config.test_asr_path=/nfs/yangguanrou.ygr/slides-finetune-wavlm_notext/asr/1760/decode_log_dev_clean_beam4_repetition_penalty1_pred \