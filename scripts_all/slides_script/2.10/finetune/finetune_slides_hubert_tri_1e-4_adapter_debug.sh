...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-lora-adapter-debug
...
--config-name "slides_adapter.yaml" \
...
++train_config.peft_config.peft_method=llama_adapter \
++\metric=acc \
...
# ++log_config.wandb_exp_name=slides-finetune-hubert-tri-1e-4-adapter \
