...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-lora-prefix-debug
...
++train_config.peft_config.peft_method=prefix \
++\metric=acc \
...
# ++log_config.wandb_exp_name=slides-finetune-hubert-tri-1e-4-prefix \
