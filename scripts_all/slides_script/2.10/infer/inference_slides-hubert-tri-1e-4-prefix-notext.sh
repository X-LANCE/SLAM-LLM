...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-prefix-notext
ckpt_path=$output_dir/asr/17920
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1_debug1
...
++peft_ckpt=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-prefix-notext/asr/17920/ \
