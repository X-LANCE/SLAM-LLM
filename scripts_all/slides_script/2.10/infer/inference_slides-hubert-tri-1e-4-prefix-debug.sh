...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-prefix
ckpt_path=$output_dir/asr/7920
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1-debug
...
++peft_config.peft_method=prefix \
++peft_ckpt=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-prefix/asr/7920 \
