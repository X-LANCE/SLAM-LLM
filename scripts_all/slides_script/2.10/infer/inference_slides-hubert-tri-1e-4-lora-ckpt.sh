...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-lora-ckpt
ckpt_path=$output_dir/asr/1640
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1_debug

# -m debugpy --listen 5678 --wait-for-client
python -m debugpy --listen 5679 --wait-for-client src/llama_recipes/pipeline/inference_batch.py \
...
++peft_ckpt=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-lora-ckpt/asr/1640/ \
