...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-adapter
ckpt_path=$output_dir/asr/9880
...
++peft_ckpt=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-adapter/asr/9880/ \
