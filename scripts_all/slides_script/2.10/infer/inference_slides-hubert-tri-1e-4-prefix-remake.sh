...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-prefix-remake
ckpt_path=$output_dir/asr/3640
...
--config-name "slides_prefix.yaml" \
...
++peft_ckpt=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-prefix-remake/asr/3640/ \
