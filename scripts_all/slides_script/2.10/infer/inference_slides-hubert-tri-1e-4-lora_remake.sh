...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-lora-remake
...
++peft_ckpt=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-1e-4-lora-remake/asr/1640/ \
