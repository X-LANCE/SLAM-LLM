...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-5e-5-s95
...
++dataset_config.train_scp_file_path="/nfs/yangguanrou.ygr/slidespeech/train_95/" \
...
++log_config.wandb_exp_name=slides-finetune-hubert-tri-5e-5-s95 \
