...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-5e-5-linearconv
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1_sample_debug
