...
llm_path=/nfs/yangguanrou.ygr/models/Qwen1.5-7B-Chat

output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-5e-4-qwen1.5
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1_1_debug
