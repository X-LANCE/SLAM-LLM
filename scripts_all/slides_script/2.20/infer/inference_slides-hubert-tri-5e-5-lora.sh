...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-5e-5-lora
ckpt_path=$output_dir/asr/17640
...
++peft_ckpt=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-5e-5-lora/asr/17640/ \