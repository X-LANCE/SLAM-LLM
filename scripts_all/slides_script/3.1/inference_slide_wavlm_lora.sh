...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-wavlm-lora
ckpt_path=$output_dir/asr/23760
...
++peft_ckpt=/nfs/yangguanrou.ygr/slides-finetune-wavlm-lora/asr/23760/ \