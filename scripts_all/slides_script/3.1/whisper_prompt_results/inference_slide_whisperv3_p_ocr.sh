...
decode_log=/root/SLAM-LLM/slides_script/3.1/whisper_prompt_results/decode_test_whisper_ocr

# -m debugpy --listen 5678 --wait-for-client
python src/llama_recipes/pipeline/inference_batch_whisperv3_prompt.py \
