...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-hubert-tri-5e-5-linearconv-warmup
...
decode_log=/root/SLAM-LLM/slides_script/3.1/decode_log_dev_clean_beam4_repetition_penalty1_bs2_debug

# -m debugpy --listen 5678 --wait-for-client -m debugpy --listen 5679 --wait-for-client 
