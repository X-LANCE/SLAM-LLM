...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-wavlm_prev
ckpt_path=$output_dir/asr/5760
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1_online

# -m debugpy --listen 5678 --wait-for-client
python -m debugpy --listen 5678 --wait-for-client src/llama_recipes/pipeline/inference_batch.py \
...
++dataset_config.last_pred_path=$ckpt_path/test_last_pred \
...
#++dataset_config.test_asr_path=/nfs/yangguanrou.ygr/slides-finetune-whisperv3_notext/asr/19760/decode_log_test_clean_beam4_repetition_penalty1_pred \