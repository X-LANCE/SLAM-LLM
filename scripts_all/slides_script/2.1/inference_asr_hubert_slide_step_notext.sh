...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-notext-20230128-continue
ckpt_path=$output_dir/asr/30000
...
decode_log=$ckpt_path/decode_log_test_beam4_repetition_penalty1
