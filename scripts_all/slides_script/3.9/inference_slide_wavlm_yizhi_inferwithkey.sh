...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-wavlm-yizhi
ckpt_path=$output_dir/asr/3680
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1_inferwithkey
