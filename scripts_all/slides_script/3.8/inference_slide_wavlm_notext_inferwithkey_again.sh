...
output_dir=/nfs/yangguanrou.ygr/slides-finetune-wavlm_notext
ckpt_path=$output_dir/asr/1760
...
decode_log=$ckpt_path/decode_log_test_clean_beam4_repetition_penalty1_inferwithkey_again
...
++dataset_config.task=keyword_yizhi \
