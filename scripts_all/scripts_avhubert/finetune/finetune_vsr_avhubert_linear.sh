...
log_config.wandb_exp_name=vicuna-7b-v1.5-large_vox_433h-0131-prompt \
...
# dataset_config.prompt="Transcribe the silent speech in this video to text by lip-reading the speaker\'s clear and visible lip movements." \