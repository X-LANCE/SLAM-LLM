...
decode_log=/root/SLAM-LLM/scripts_all/scripts_ner_texttop/whisper_v3_encoder/decode_giga_speechtotext_gigadata
...
# bash scripts_all/scripts_ner_texttop/whisper_v3_encoder/inference_slide_whisper_speechtotext_gigadata.sh > scripts_all/scripts_ner_texttop/whisper_v3_encoder/inference_slide_whisper_speechtotext_gigadata.log