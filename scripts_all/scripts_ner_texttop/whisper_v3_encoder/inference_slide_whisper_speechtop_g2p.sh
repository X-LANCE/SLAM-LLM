...
decode_log=/root/SLAM-LLM/scripts_all/scripts_ner_texttop/whisper_v3_encoder/decode_giga_speechtop_g2p
...
++dataset_config.infer_file_name=wavlm_large_phoneme_g2p.phn \
...
# bash scripts_all/scripts_ner_texttop/whisper_v3_encoder/inference_slide_whisper_speechtop_g2p.sh > scripts_all/scripts_ner_texttop/whisper_v3_encoder/inference_slide_whisper_speechtop_g2p.log