...
--rec_file /root/SLAM-LLM/scripts_all/scripts_ner_texttop/g2p/decode_giga_speechtop_g2p_pred.proc \
> /root/SLAM-LLM/scripts_all/scripts_ner_texttop/g2p/giga_speechtop_g2p/speechtop_g2p.log
