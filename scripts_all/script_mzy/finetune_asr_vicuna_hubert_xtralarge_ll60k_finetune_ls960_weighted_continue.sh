...
output_dir=/nfs/yangguanrou.ygr/vicuna-7b-v1.5-hubert_xtralarge_ll60k_finetune_ls960_weighted_continue
...
++log_config.wandb_exp_name=vicuna-7b-v1.5-hubert_xtralarge_ll60k_finetune_ls960_weighted_continue \
++log_config.log_interval=5 \
++ckpt_path=/nfs/yangguanrou.ygr/vicuna-7b-v1.5-hubert_xtralarge_ll60k_finetune_ls960_weighted/asr/2594/model.pt \
