...
output_dir=/nfs/maziyang.mzy/exps/20240314-gigaspeech-vicuna-7b-v1.5-finetune-asr-ds5-proj2048-steplrwarmup1e-4decay-WavLM-Large
ckpt_path=$output_dir/asr/1/30000
# peft_ckpt=/nfs/maziyang.mzy/exps/llama-2-hf-finetune-asr-ds5-proj2048-lr1e-4-whisper-lora-prompt-paddinglr-20240102/asr/4
val_data_path=/nfs/maziyang.mzy/data/gigaspeech/gigaspeech_test.jsonl
decode_log=$ckpt_path/decode_log_gigaspeech_test_beam4_repetition_penalty1_bs1
