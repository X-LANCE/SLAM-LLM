...
output_dir=/nfs/yangguanrou.ygr/vicuna-7b-v1.5-finetune-sota-asr-1e-3-0121
...
--metric acc \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-sota-asr-1e-3-0121.log" \
--modality "audio" \
...
--wandb_exp_name vicuna-7b-v1.5-finetune-sota-asr-20230119 \
--log_interval 5 \
...
--output_dir $output_dir \
--metric acc \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-sota-asr-1e-3-0121" \
--modality "audio" \
...
--wandb_entity_name yanghaha \
--wandb_project_name slam-llm \
--wandb_exp_name vicuna-7b-v1.5-finetune-sota-asr-1e-3-0121 \
--log_interval 5 \
