...
output_dir=/nfs/yangguanrou.ygr/vicuna-7b-v1.5-finetune-sota-asr-20230119
...
--metric acc \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-sota-asr-20230119.log" \
--modality "audio" \
...
--output_dir $output_dir \
--metric acc \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-sota-asr-20230119" \
--modality "audio" \
--pretrained_model_path "/nfs/yangguanrou.ygr/auto_avsr/asr_trlrwlrs2lrs3vox2avsp_base.pth" \
--use_wandb \
--wandb_dir $output_dir \
