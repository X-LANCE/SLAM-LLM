...
--metric acc \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-sota-vsr-20230119.log" \
--modality "visual" \
...
--wandb_exp_name vicuna-7b-v1.5-finetune-sota-vsr-20230119 \
--log_interval 5 \
...
--output_dir $output_dir \
--metric acc \
--log_file "/root/SLAM-LLM/log/vicuna-7b-v1.5-finetune-sota-vsr-20230119" \
--modality "visual" \
--pretrained_model_path "/nfs/yangguanrou.ygr/auto_avsr/vsr_trlrwlrs2lrs3vox2avsp_base.pth" \
--use_wandb \
--wandb_dir $output_dir \
