...
from llama_recipes.models.SOTA_AV.espnet.nets.e2e_asr_common import end_detect
from llama_recipes.models.SOTA_AV.espnet.nets.scorer_interface import PartialScorerInterface, ScorerInterface
