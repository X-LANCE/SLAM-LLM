...
python /root/SLAM-LLM/src/llama_recipes/pipeline/finetune.py \
    ...
    model_config.llm_name='llama-2-7b-hf' \
    ...
    dataset_config.train_data_path='/root/data/mls_json/french_train.jsonl' \
    dataset_config.val_data_path='/root/data/mls_json/french_dev.jsonl' \
