...
output_dir=/exps/mixtral-7b-finetune-asr-linear-lora-24-dropout0.2-projector-2048-steplrwarmupkeep1e-4-whisper-largev3-fr-LID-longprompt-average-$(date +"%Y%m%d")-test
...
++train_config.peft_config.lora_dropout=0.2 \
