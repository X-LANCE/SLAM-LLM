...
trans="/exps/mixtral-7b-finetune-asr-mls-linear-lora-24-projector-2048-weightsum-steplrwarmupkeep1e-4-whisper-largev3-fr-LID-longprompt-average-20240410-test/asr/average/decode_log_test_beam4_gt"
preds="/exps/mixtral-7b-finetune-asr-mls-linear-lora-24-projector-2048-weightsum-steplrwarmupkeep1e-4-whisper-largev3-fr-LID-longprompt-average-20240410-test/asr/average/decode_log_test_beam4_pred"
