...
btz=16
lr=1e-4
exp_name=wavcaps_pt-seed${seed}_btz${btz}_lr${lr}-random_crop

train_data_path=/root/data/merged_data.jsonl
# train_data_path=/root/data/Rag/clotho_jsonl/development_rag_as_ac_cl.jsonl
# train_data_path=/root/data/Clotho_v2/development.jsonl

val_data_path=/root/data/Clotho_v2/validation.jsonl
# val_data_path=/root/data/Rag/clotho_jsonl/validation_rag_as_ac_cl.jsonl
...
python /root/SLAM-LLM/src/llama_recipes/pipeline/finetune.py \
    ...
    train_config.warmup_steps=50000 \
    ...
    train_config.run_validation=false \
    dataset_config.random_crop=true \
