...
++model_config.encoder_name="iic/speech_paraformer-large_asr_nat-zh-cn-16k-common-vocab8404-pytorch" \
++model_config.encoder_ds_rate=1 \
++model_config.encoder_path=$speech_encoder_path \
++model_config.encoder_dim=512 \
++model_config.encoder_projector=linear \
++model_config.encoder_projector_ds_rate=1 \
++dataset_config.fix_length_audio=64 \
++dataset_config.dataset=speech_dataset_nar \
++dataset_config.file="src/llama_recipes/datasets/speech_dataset_nar.py:get_speech_dataset" \
++dataset_config.input_type="paraformer_fbank" \
