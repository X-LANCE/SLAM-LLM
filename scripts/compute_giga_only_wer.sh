...
trans=/root/SLAM-LLM/mzy/only_gigatn/dev_viterbi_gt
preds=/root/SLAM-LLM/mzy/only_gigatn/dev_viterbi_pred

trans=/root/SLAM-LLM/mzy/only_gigatn/test_viterbi_gt
preds=/root/SLAM-LLM/mzy/only_gigatn/test_viterbi_pred

trans=/root/SLAM-LLM/mzy/viterbi/test_viterbi_gt
preds=/root/SLAM-LLM/mzy/viterbi/test_viterbi_pred

trans=/root/SLAM-LLM/mzy/viterbi/dev_viterbi_gt
preds=/root/SLAM-LLM/mzy/viterbi/dev_viterbi_pred


python src/slam_llm/utils/giga_tn.py ${trans} ${trans}.proc1
python src/slam_llm/utils/giga_tn.py ${preds} ${preds}.proc1
python src/llama_recipes/utils/compute_wer.py ${trans}.proc1 ${preds}.proc1 ${preds}.gigaproc.wer
