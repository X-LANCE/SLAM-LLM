...
llm_path=/host/model_ckpt/CohereForAI/aya-101
# llm_path=/nfs/maziyang.mzy/models/vicuna-13b-v1.5

output_dir=/work/exps/aya-finetune-asr-linear-steplrwarmupkeep1e-4-whisper-largev3-$(date +"%Y%m%d")-test

hydra_args="
hydra.run.dir=$output_dir \
++model_config.llm_name="aya-101" \
