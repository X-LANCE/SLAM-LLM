...
for N in 100; do
        for ref_split in test_clean ; do #test_other
                ...
                python -m debugpy --listen 5678 --wait-for-client $code_dir/inference_contextual_asr_batch.py \
                        --config-path "conf" \
                        ...
                        ++dataset_config.file=examples/contextual_asr/dataset/hotwordsinfer_dataset.py:get_speech_dataset \
...
# bash /root/SLAM-LLM/examples/hotwords_librispeech/scripts_libri960/infer/3/filter_infer_sen_for_each_word/bs1_remake/decode_wavlm_libri960_ft_char_hotwords_filter_N100_first1_remake_debug.sh > /root/SLAM-LLM/examples/hotwords_librispeech/scripts_libri960/infer/3/filter_infer_sen_for_each_word/bs1_remake/decode_wavlm_libri960_ft_char_hotwords_filter_N100_first1_remake_debug.log