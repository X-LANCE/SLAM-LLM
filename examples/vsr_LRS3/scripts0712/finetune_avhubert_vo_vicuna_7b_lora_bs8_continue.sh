...
output_dir=/root/tmp/vicuna-7b-v1.5-large_vox_433h_bs8_con-$(date +"%Y%m%d")
...
+log_config.wandb_exp_name=large_vox_433h_lora_bs8_con \
+log_config.log_interval=5 \
+ckpt_path=/root/tmp/vicuna-7b-v1.5-large_vox_433h_bs8-20240707/vsr_epoch_6_step_5695/model.pt \
"
