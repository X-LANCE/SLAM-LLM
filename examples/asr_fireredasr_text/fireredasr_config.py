...
@dataclass
class ModelConfig:
    file: str = "examples/asr_fireredasr_text/model/slam_fireredasr.py"
...
class DataConfig:
    ...
    file: str = "examples/asr_fireredasr_text/model/slam_fireredasr.py:get_speech_dataset"
