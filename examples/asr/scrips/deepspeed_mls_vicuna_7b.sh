...
output_dir=/work/exps/vicuna-7b-v1.5-mls-polish-linear-lora-32-steplrwarmupkeep1e-4-whisper-largev3-$(date +"%Y%m%d")-deepspeed
...
++dataset_config.val_data_path=data/mls/polish_tem.jsonl \
