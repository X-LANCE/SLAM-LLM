...
speech_encoder_path=/nfs/yangguanrou.ygr/ckpts/wavlm_large_ft_libri960_token/wavlm_large_ft_libri960_token.pt
llm_path=/nfs/maziyang.mzy/models/vicuna-7b-v1.5

output_dir=/nfs/yangguanrou.ygr/experiments_librispeech/vicuna-7b-v1.5-WavLM-Large-libri960-ft-token-hotwords-20240524
...
for ref_split in test_clean test_other; do
        ...
        python $code_dir/inference_asr_batch.py \
                ...
                ++dataset_config.infer_file=/nfs/yangguanrou.ygr/data/fbai-speech/is21_deep_bias/my_ref/${ref_split}.biasing_100.tsv \
