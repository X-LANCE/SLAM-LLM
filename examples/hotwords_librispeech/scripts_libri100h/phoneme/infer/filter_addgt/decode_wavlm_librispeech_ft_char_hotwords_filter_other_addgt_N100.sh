...
decode_log=$ckpt_path/decode_${split}_beam4_filter_addgt_N100
...
# bash examples/hotwords_librispeech/scripts/phoneme/filter_addgt/decode_wavlm_librispeech_ft_char_hotwords_filter_other_addgt_N100.sh > examples/hotwords_librispeech/scripts/phoneme/filter_addgt/decode_wavlm_librispeech_ft_char_hotwords_filter_other_addgt_N100.log
