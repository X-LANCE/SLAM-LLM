...
# bash examples/hotwords_librispeech/scripts/phoneme/filter_addgt/decode_wavlm_librispeech_ft_char_hotwords_filter_clean_addgt_N1000.sh > examples/hotwords_librispeech/scripts/phoneme/filter_addgt/decode_wavlm_librispeech_ft_char_hotwords_filter_clean_addgt_N1000.log
