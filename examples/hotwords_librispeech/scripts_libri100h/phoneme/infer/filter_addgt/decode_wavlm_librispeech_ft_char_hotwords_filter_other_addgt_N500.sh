...
decode_log=$ckpt_path/decode_${split}_beam4_filter_addgt_N500
...
python $code_dir/inference_asr_batch.py \
        ...
        ++dataset_config.infer_file=/nfs/yangguanrou.ygr/data/fbai-speech/is21_deep_bias/my_ref/test-other.biasing_500.tsv \
...
# bash examples/hotwords_librispeech/scripts/phoneme/filter_addgt/decode_wavlm_librispeech_ft_char_hotwords_filter_other_addgt_N500.sh > examples/hotwords_librispeech/scripts/phoneme/filter_addgt/decode_wavlm_librispeech_ft_char_hotwords_filter_other_addgt_N500.log
