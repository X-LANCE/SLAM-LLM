...
# bash examples/hotwords_librispeech/scripts/phoneme/filter/decode_wavlm_librispeech_ft_char_hotwords_filter_other_N100.sh > examples/hotwords_librispeech/scripts/phoneme/filter/decode_wavlm_librispeech_ft_char_hotwords_filter_other_N100.log