...
output_dir=/nfs/yangguanrou.ygr/experiments_librispeech2/vicuna-7b-v1.5-hubert-ft-char-hotwords-again-$(date +"%Y%m%d")
...
++log_config.wandb_exp_name=vicuna-7b-v1.5-hubert-ft-char-hotwords \
