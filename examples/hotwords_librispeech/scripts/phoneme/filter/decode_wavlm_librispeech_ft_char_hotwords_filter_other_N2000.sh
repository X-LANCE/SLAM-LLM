...
python $code_dir/inference_asr_batch.py \
        ...
        ++dataset_config.infer_file=/nfs/yangguanrou.ygr/data/fbai-speech/is21_deep_bias/my_ref/test-other.biasing_2000.tsv \
...
# bash examples/hotwords_librispeech/scripts/phoneme/filter/decode_wavlm_librispeech_ft_char_hotwords_filter_other_N2000.sh > examples/hotwords_librispeech/scripts/phoneme/filter/decode_wavlm_librispeech_ft_char_hotwords_filter_other_N2000.log