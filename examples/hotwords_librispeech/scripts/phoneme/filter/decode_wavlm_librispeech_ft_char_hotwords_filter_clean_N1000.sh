...
decode_log=$ckpt_path/decode_${split}_beam4_filter_N1000
...
python $code_dir/inference_asr_batch.py \
        ...
        ++dataset_config.infer_file=/nfs/yangguanrou.ygr/data/fbai-speech/is21_deep_bias/my_ref/test-clean.biasing_1000.tsv \
...
# bash examples/hotwords_librispeech/scripts/phoneme/filter/decode_wavlm_librispeech_ft_char_hotwords_filter_clean_N1000.sh > examples/hotwords_librispeech/scripts/phoneme/filter/decode_wavlm_librispeech_ft_char_hotwords_filter_clean_N1000.log