...
# bash examples/hotwords_librispeech/scripts_libri960_phn/infer/filter/decode_wavlm_libri960_ft_char_hotwords_filter_N2000.sh > examples/hotwords_librispeech/scripts_libri960_phn/infer/filter/decode_wavlm_libri960_ft_char_hotwords_filter_N2000.log