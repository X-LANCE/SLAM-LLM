...
for N in 100; do
        for ref_split in test_clean test_other; do
                ...
                decode_log=$ckpt_path/decode_${split}_beam4_filter_addgt_N${N}
...
# bash examples/hotwords_librispeech/scripts_libri960_phn/infer/decode_wavlm_libri960_ft_char_hotwords_filter_addgt_N100.sh > examples/hotwords_librispeech/scripts_libri960_phn/infer/decode_wavlm_libri960_ft_char_hotwords_filter_addgt_N100.log