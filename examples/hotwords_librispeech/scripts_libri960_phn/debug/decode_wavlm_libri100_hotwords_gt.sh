...
output_dir=/nfs/yangguanrou.ygr/experiments_librispeech/vicuna-7b-v1.5-WavLM-Large-ft-char-hotwords-20240510
...
for ref_split in test_clean test_other; do
        ...
        decode_log=$ckpt_path/decode_${split}_beam4_gt_remakefordebug
