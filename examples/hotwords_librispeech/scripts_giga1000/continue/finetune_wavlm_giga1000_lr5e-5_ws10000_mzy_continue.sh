...
output_dir=/nfs/yangguanrou.ygr/experiments_librispeech/vicuna-7b-v1.5-WavLM-Large-gigaspeech-lr5e-5-ws10000-mzy-continue-$(date +"%Y%m%d")
...
++log_config.wandb_exp_name=vicuna-7b-v1.5-WavLM-Large-gigaspeech-lr5e-5-ws10000-mzy-continue \
++log_config.log_interval=5 \
++ckpt_path=/nfs/yangguanrou.ygr/experiments_gigaspeech/tiaocan/vicuna-7b-v1.5-WavLM-Large-gigaspeech-lr5e-5-ws10000-mzy-20240525/asr_epoch_1_step_72000/model.pt \
"
