...
train_data_path=/nfs/zhifu.gzf/data/datalist/gigaspeech/gigaspeech_wav_train_1000h.json
val_data_path=/nfs/maziyang.mzy/data/gigaspeech/gigaspeech_dev.jsonl

output_dir=/nfs/yangguanrou.ygr/experiments_librispeech/vicuna-7b-v1.5-WavLM-Large-giga1000-ft-char-hotwords1-$(date +"%Y%m%d")-cont
...
++log_config.wandb_exp_name=vicuna-7b-v1.5-WavLM-Large-giga1000-ft-char-hotwords1-cont \
++log_config.log_interval=5 \
++ckpt_path=/nfs/yangguanrou.ygr/experiments_librispeech/vicuna-7b-v1.5-WavLM-Large-giga1000-ft-char-hotwords1-20240523/asr_epoch_1_step_18000/model.pt \
"
