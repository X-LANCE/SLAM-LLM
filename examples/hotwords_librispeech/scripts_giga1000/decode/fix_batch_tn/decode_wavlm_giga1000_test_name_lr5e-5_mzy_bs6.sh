...
output_dir=/nfs/yangguanrou.ygr/experiments_gigaspeech/tiaocan/vicuna-7b-v1.5-WavLM-Large-gigaspeech-lr5e-5-ws10000-mzy-20240525/
ckpt_path=$output_dir/asr_epoch_1_step_72000

for ref_split in test_name; do
        decode_log=$ckpt_path/decode_${ref_split}_beam4_bs6
        python $code_dir/inference_asr_batch.py \
                ...
                ++dataset_config.dataset=giga_fix_dataset \
                ++dataset_config.file=src/slam_llm/datasets/giga_fix_dataset.py:get_speech_dataset \
