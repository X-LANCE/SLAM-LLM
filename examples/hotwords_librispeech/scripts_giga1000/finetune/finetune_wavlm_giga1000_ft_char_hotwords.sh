...
output_dir=/nfs/yangguanrou.ygr/experiments_librispeech/vicuna-7b-v1.5-WavLM-Large-giga1000-ft-char-hotwords1-$(date +"%Y%m%d")
...
++log_config.wandb_exp_name=vicuna-7b-v1.5-WavLM-Large-giga1000-ft-char-hotwords1 \
