...
decode_log=/root/SLAM-LLM/examples/hotwords_librispeech/scripts_giga1000/whisperv3/whisperv3_${split}_debug

# -m debugpy --listen 5678 --wait-for-client
python -m debugpy --listen 5678 --wait-for-client $code_dir/inference_asr_batch_whisper.py \
        --config-path "conf" \
