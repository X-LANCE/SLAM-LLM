...
output_dir=/nfs/yangguanrou.ygr/experiments_gigaspeech_lora/ft_wavlm_giga1000_lora_r32-ft-char-hotwords-$(date +"%Y%m%d")
...
++log_config.wandb_exp_name=ft_wavlm_giga1000_lora_r32_ft-char-hotwords \
