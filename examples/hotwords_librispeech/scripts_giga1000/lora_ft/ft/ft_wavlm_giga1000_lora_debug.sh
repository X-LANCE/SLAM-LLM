...
val_data_path=/nfs/maziyang.mzy/data/gigaspeech/gigaspeech_dev_first10.jsonl

output_dir=/nfs/yangguanrou.ygr/experiments_gigaspeech_lora/ft_wavlm_giga1000_lora-$(date +"%Y%m%d")
...
# ++log_config.wandb_exp_name=ft_wavlm_giga1000_lora \
