...
for ref_split in test_name; do
        decode_log=$ckpt_path/decode_${ref_split}_beam4_filter_fw_wordnum2_tn
        python $code_dir/inference_asr_batch.py \
                ...
                ++dataset_config.file=src/slam_llm/datasets/giga_hotwordsinfer_tn_dataset.py:get_speech_dataset \
                ++dataset_config.ctc_file=/nfs/yangguanrou.ygr/data/gigaspeech_my_infer/wavlm_ft_char_giga1000.txt \
                ++dataset_config.word_num=2 \
...
# bash examples/hotwords_librispeech/scripts_giga1000/lora_ft/infer_r32_ftchar_hotwords/filter_words/tn/decode_wavlm_giga1000_ft_char_last_filter_fw_0.95_2.sh > examples/hotwords_librispeech/scripts_giga1000/lora_ft/infer_r32_ftchar_hotwords/filter_words/tn/decode_wavlm_giga1000_ft_char_last_filter_fw_0.95_2.log