...
for ref_split in test_name; do
        decode_log=$ckpt_path/decode_${ref_split}_beam4_filter_fw_single
...
# bash examples/hotwords_librispeech/scripts_giga1000/lora_ft/infer_r32_ftchar_hotwords/filter_words_single/decode_wavlm_giga1000_ft_char_last_filter_fw_single.sh > examples/hotwords_librispeech/scripts_giga1000/lora_ft/infer_r32_ftchar_hotwords/filter_words_single/decode_wavlm_giga1000_ft_char_last_filter_fw_single.log