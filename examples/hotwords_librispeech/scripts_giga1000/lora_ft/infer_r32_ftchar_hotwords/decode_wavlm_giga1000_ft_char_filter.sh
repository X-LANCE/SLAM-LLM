...
ckpt_path=$output_dir/asr_epoch_1_step_56000
...
# bash examples/hotwords_librispeech/scripts_giga1000/lora_ft/infer_r32_ftchar_hotwords/decode_wavlm_giga1000_ft_char_filter.sh > examples/hotwords_librispeech/scripts_giga1000/lora_ft/infer_r32_ftchar_hotwords/decode_wavlm_giga1000_ft_char_filter.log