...
output_dir=/nfs/yangguanrou.ygr/experiments_gigaspeech_lora/ft_wavlm_giga1000_lora-20240616/
ckpt_path=$output_dir/asr_epoch_1_step_52000

for ref_split in test_name; do
        decode_log=$ckpt_path/decode_${ref_split}_beam4_step52000
