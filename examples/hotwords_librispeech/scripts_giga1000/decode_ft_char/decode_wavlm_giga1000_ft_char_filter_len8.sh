...
output_dir=/nfs/yangguanrou.ygr/experiments_librispeech/vicuna-7b-v1.5-WavLM-Large-gigaspeech-ft_char-hotwords-20240527
...
# bash examples/hotwords_librispeech/scripts_giga1000/decode_ft_char/decode_wavlm_giga1000_ft_char_filter_len8.sh > examples/hotwords_librispeech/scripts_giga1000/decode_ft_char/decode_wavlm_giga1000_ft_char_filter_len8.log