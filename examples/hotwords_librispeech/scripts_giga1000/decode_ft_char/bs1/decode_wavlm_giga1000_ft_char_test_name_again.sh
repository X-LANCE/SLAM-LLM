...
output_dir=/nfs/yangguanrou.ygr/experiments_gigaspeech/vicuna-7b-v1.5-WavLM-Large-gigaspeech-ft_char-20240527
ckpt_path=$output_dir/asr_epoch_1_step_48000

for ref_split in test_name; do
        decode_log=$ckpt_path/decode_${ref_split}_beam4_bs1_again
