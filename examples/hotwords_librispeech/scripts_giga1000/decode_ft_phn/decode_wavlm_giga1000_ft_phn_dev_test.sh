...
output_dir=/nfs/yangguanrou.ygr/experiments_librispeech/vicuna-7b-v1.5-WavLM-Large-gigaspeech-ft_phn-20240528
ckpt_path=$output_dir/asr_epoch_1_step_84000

for ref_split in dev test; do
