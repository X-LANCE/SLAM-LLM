...
# bash examples/hotwords_librispeech/scripts_libri960/decode_wavlm_libri960_ft_char_hotwords_filter_addgt_N1000.sh > examples/hotwords_librispeech/scripts_libri960/decode_wavlm_libri960_ft_char_hotwords_filter_addgt_N1000.log