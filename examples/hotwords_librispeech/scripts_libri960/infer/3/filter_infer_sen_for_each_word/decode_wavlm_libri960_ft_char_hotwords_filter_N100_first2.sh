...
for N in 100; do
        for ref_split in test_clean test_other; do
                ...
                decode_log=$ckpt_path/decode_${split}_beam4_filter_N${N}_first${first}
...
# bash examples/hotwords_librispeech/scripts_libri960/infer/3/filter_infer_sen_for_each_word/decode_wavlm_libri960_ft_char_hotwords_filter_N100_first2.sh > examples/hotwords_librispeech/scripts_libri960/infer/3/filter_infer_sen_for_each_word/decode_wavlm_libri960_ft_char_hotwords_filter_N100_first2.log