...
# bash examples/hotwords_librispeech/scripts_libri960/infer/3/filter_infer_sen_for_each_word/decode_wavlm_libri960_ft_char_hotwords_filter_N100_first1.sh > examples/hotwords_librispeech/scripts_libri960/infer/3/filter_infer_sen_for_each_word/decode_wavlm_libri960_ft_char_hotwords_filter_N100_first1.log