...
for N in 500; do
        for ref_split in test_clean test_other; do
                ...
                decode_log=$ckpt_path/decode_${split}_beam4_filter_N${N}_num5_0.95_fis
...
# bash examples/hotwords_librispeech/scripts_libri960/infer/3/filter_infer_sen/other/decode_wavlm_libri960_ft_char_hotwords_filter_N500_num5_0.95.sh > examples/hotwords_librispeech/scripts_libri960/infer/3/filter_infer_sen/other/decode_wavlm_libri960_ft_char_hotwords_filter_N500_num5_0.95.log