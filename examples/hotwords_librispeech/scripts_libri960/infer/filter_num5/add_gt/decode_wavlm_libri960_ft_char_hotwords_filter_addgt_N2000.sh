...
for N in 2000; do
        for ref_split in test_clean test_other; do
                ...
                decode_log=$ckpt_path/decode_${split}_beam4_filter_addgt_N${N}_num5
...
# bash examples/hotwords_librispeech/scripts_libri960/infer/filter_num5/add_gt/decode_wavlm_libri960_ft_char_hotwords_filter_addgt_N2000.sh > examples/hotwords_librispeech/scripts_libri960/infer/filter_num5/add_gt/decode_wavlm_libri960_ft_char_hotwords_filter_addgt_N2000.log