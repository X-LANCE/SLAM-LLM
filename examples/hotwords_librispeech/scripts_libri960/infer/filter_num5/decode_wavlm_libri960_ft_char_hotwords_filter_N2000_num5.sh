...
for N in 2000; do
        for ref_split in test_clean test_other; do
                ...
                decode_log=$ckpt_path/decode_${split}_beam4_filter_N${N}_num5
...
# bash examples/hotwords_librispeech/scripts_libri960/infer/filter_num5/decode_wavlm_libri960_ft_char_hotwords_filter_N2000_num5.sh > examples/hotwords_librispeech/scripts_libri960/infer/filter_num5/decode_wavlm_libri960_ft_char_hotwords_filter_N2000_num5.log