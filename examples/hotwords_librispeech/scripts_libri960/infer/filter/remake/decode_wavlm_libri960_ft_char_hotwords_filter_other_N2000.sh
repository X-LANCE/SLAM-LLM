...
for N in 2000; do
        for ref_split in test_other; do
...
# bash examples/hotwords_librispeech/scripts_libri960/decode_wavlm_libri960_ft_char_hotwords_filter_other_N2000.sh > examples/hotwords_librispeech/scripts_libri960/decode_wavlm_libri960_ft_char_hotwords_filter_other_N2000.log