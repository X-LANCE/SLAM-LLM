...
speech_encoder_path=${run_dir}/models/large-v3.pt
llm_path=${run_dir}/models/vicuna-7b-v1.5

timestamp=$(date +"%Y%m%d%H%M%S")
output_dir=${run_dir}/out/vicuna-7b-v1.5-librispeech-linear-steplrwarmupkeep1e-4-whisper-largev3--${timestamp}

ckpt_path=${run_dir}/models
split=librispeech_test_clean

val_data_path=${run_dir}/data/loaded_librispeech_test_clean.jsonl
