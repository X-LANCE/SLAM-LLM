...
export PYTHONPATH=$PYTHONPATH:/work/van-speech-nlp/jindaznb/jslpnb/mllm_expriments/fairseq
...
output_dir=${run_dir}/out/TinyLlama-1.1B-Chat-v1.0-librispeech-linear-steplrwarmupkeep1e-4-hubert-large-$(date +"%Y%m%d")/${test_speaker}
...
++model_config.encoder_name=wav2phoneme \
