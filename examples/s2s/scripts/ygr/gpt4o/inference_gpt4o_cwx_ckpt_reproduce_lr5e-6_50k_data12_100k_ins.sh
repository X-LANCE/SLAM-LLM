...
codec_decoder_path="/nfs/yangguanrou.ygr/ckpts/CosyVoice/CosyVoice-300M-Instruct"

tts_adapter=false
task_type=tts


ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/ft_gpt4o_cwx_ckpt_reproduce_lr5e-6_50k_data12_100k/s2s_epoch_116_step_815
split=test
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_gpt4o_test_instruct
