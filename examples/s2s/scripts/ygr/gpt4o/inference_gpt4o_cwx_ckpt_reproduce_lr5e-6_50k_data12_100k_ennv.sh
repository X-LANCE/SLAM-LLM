...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_gpt4o_test_ennv
...
python $code_dir/inference_s2s.py \
        ...
        ++dataset_config.spk_embedding="english_female" \
