...
# log settings
exp_name="ft_gpt4o_cwx_ckpt_reproduce_lr5e-6_50k_data12_100k"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/en/VoiceAssistant-400K-v2_reproduce/s2s_epoch_6_step_3495  # this line is for resuming training
