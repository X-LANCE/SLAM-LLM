...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/Belle_manifest/train.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/Belle_manifest/val.jsonl"
...
# log settings
exp_name="belle_pretrain_zh_prompt"
