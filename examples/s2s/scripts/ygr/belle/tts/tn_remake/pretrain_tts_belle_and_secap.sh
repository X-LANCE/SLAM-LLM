...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/Belle_manifest/belle_and_secap/train_clean.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/Belle_manifest/belle_and_secap/val_clean.jsonl"
...
# log settings
exp_name="belle_pretrain_remake_belle_and_secap"
