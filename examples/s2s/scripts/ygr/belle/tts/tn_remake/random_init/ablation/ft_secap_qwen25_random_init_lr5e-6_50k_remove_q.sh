...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/secap_my/remove_quater_emotion_prompt_diversity/train_remove_q.jsonl"
...
# log settings
exp_name="ft_secap_qwen25_random_init_lr5e-6_50k_remove_q"
