...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/secap_my/remove_quater_emotion_prompt_diversity/train_remove_h.jsonl"
...
# log settings
exp_name="ft_secap_qwen25_random_init_lr5e-6_50k_remove_h"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/belle_pretrain_remake_qwen2.5_random_init/s2s_epoch_2_step_31841  # this line is for resuming training
