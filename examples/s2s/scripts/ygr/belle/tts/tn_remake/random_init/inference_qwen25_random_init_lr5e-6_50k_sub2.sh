...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/ft_secap_qwen25_random_init_lr5e-6_50k/s2s_epoch_8_step_2677
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/secap_my/test_sub2.jsonl
# # huggingface dataset
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_secap_test_sub2
