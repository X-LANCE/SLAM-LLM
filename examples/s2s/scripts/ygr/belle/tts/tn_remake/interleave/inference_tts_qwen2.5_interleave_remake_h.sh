...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/belle_pretrain_remake_qwen2.5_interleave_remake/s2s_epoch_1_step_150000
split=test
...
python $code_dir/inference_s2s.py \
        ...
        ++train_config.find_unused_parameters=true \
