...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/secap_my/dpo/first_trial/train.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/secap_my/dpo/first_trial/val.jsonl"
...
# log settings
exp_name="dpo_secap_qwen25_lr5e-6_50k"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/belle_pretrain_remake_qwen2.5/s2s_epoch_2_step_31841  # this line is for resuming training
...
++model_config.file=examples/s2s/model/slam_model_s2s_dpo.py:model_factory \
...
++dataset_config.file=examples/s2s/speech_dataset_s2s_dpo.py:get_speech_dataset \
