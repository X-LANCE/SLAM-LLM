...
# log settings
# exp_name="ft_secap_qwen25_lr5e-6_50k" #忘改了！
exp_name="ft_secap_qwen25_lr5e-6_50k_no_text" #忘改了！
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/belle_pretrain_remake_qwen2.5_no_text/s2s_epoch_2_step_31841  # this line is for resuming training
