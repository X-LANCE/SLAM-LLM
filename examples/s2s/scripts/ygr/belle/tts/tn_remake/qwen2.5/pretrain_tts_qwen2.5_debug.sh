...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/secap_my/dpo/first_trial/val_debug.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/secap_my/dpo/first_trial/val_debug.jsonl"
