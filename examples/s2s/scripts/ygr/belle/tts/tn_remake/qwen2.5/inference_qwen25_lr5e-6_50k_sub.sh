...
val_data_path=/nfs/yangguanrou.ygr/data/secap_my/test_sub.jsonl
# # huggingface dataset
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_secap_test_sub
