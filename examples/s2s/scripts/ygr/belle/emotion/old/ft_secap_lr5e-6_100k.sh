...
# log settings
exp_name="ft_secap_belle_ckpt_lr5e-6_50k"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/belle_pretrain/s2s_epoch_2_step_40841  # this line is for resuming training
