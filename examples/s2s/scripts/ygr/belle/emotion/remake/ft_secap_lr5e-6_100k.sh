...
# log settings
exp_name="ft_secap_belle_and_secap_lr5e-6_100k"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/belle_pretrain_remake_belle_and_secap/s2s_epoch_2_step_30619  # this line is for resuming training
