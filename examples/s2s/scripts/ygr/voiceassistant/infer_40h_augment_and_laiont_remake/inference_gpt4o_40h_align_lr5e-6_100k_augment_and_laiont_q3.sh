...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/ft_gpt4o_40h_align_lr5e-6_100k_augment_and_laiont/s2s_epoch_16_step_2005
split=test
