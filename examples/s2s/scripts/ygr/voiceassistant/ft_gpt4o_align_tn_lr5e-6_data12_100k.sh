...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/gpt4o_second/train_12_cosyvoice_normalized.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/gpt4o/val_cosyvoice_normalized.jsonl"
...
# log settings
exp_name="ft_gpt4o_align_tn_lr5e-6_data12_100k"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/VoiceAssistant_pretrain_align_tn/s2s_epoch_5_step_13596  # this line is for resuming training
