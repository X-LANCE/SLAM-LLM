...
val_data_path=/nfs/yangguanrou.ygr/data/gpt4o_third/dpo/train_0_8000.jsonl.${i}
# # huggingface dataset
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_gpt4o_train_0_8000_${i}
