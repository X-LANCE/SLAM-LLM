...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/ft_gpt4o_40h_align_lr5e-6_200k_augment/s2s_epoch_73_step_1464
split=test
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_gpt4o_train_0_8000
...
for i in {0..3}
do
    val_data_path=/nfs/yangguanrou.ygr/data/gpt4o_third/dpo/train_0_8000.jsonl.$((i+4))
# -m debugpy --listen 5678 --wait-for-client
    CUDA_VISIBLE_DEVICES=$i python $code_dir/inference_s2s.py \
            ...
            ++decode_log=${decode_log}_shard$((i+4)) \
