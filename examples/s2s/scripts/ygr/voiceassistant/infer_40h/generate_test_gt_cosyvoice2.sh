...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/ft_gpt4o_40h_align_lr5e-6_200k/s2s_epoch_218_step_568
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/gpt4o_third/test_cosyvoice2/test_cosyvoice2.jsonl
# # huggingface dataset
...
decode_log=/nfs/yangguanrou.ygr/data/gpt4o/reconstruct_test
...
python $code_dir/inference_s2s_gt_test.py \
        --config-path "conf" \
