...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/gpt4o_third/expanded_train_and_laiont.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/gpt4o/val.jsonl"
...
# log settings
exp_name="ft_gpt4o_40h_align_lr5e-6_100k_augment_and_laiont"
