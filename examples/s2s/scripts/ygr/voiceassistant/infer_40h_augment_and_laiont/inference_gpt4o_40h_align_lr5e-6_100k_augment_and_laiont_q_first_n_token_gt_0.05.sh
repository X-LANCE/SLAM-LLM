...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/ft_gpt4o_40h_align_lr5e-6_100k_augment_and_laiont/s2s_epoch_6_step_2335
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/gpt4o/test.jsonl
# # huggingface dataset
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_gpt4o_test_first_n_token_gt_0.05
...
python $code_dir/inference_s2s.py \
        ...
        ++dataset_config.first_n_token_gt=true \
        ++dataset_config.first_gt_percent=0.05 \
