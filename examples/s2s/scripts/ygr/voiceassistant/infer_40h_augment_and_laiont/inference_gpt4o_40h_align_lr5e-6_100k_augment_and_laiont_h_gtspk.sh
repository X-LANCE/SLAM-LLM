...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/ft_gpt4o_40h_align_lr5e-6_100k_augment_and_laiont/s2s_epoch_12_step_137
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/gpt4o/test_with_spk.jsonl
# # huggingface dataset
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_gpt4o_test_gt_spk
...
python $code_dir/inference_s2s.py \
        ...
        ++dataset_config.use_gt_spk_vector=true \
