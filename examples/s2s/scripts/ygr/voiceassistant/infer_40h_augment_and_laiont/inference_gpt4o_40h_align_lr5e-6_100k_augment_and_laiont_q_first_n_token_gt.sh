...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_gpt4o_test_first_n_token_gt_0.1
...
python $code_dir/inference_s2s.py \
        ...
        ++dataset_config.first_gt_percent=0.1 \
