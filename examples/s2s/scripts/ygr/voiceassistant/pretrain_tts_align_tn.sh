...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/VoiceAssistant-400K-v2/train_jsonl_split/train_tn.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/VoiceAssistant-400K-v2/val.jsonl"
...
# log settings
exp_name="VoiceAssistant_pretrain_align_tn"
