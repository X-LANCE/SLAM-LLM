...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/Emotion/secap_data/cosyvoice1_50HZ_token/train.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/Emotion/secap_data/cosyvoice1_50HZ_token/val.jsonl"
...
# log settings
exp_name="ft_secap_premium_ckpt_lr5e-6_50k"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/premium_pretrain/s2s_epoch_6_step_14955  # this line is for resuming training
