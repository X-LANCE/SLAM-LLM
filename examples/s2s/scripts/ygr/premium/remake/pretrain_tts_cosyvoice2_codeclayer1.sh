...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/Premium/cosyvoice2/train_clean.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/Premium/cosyvoice2/val_clean.jsonl"
...
# log settings
exp_name="premium_pretrain_remake_cosyvoice2_codeclayer1"
