...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/Premium/train_clean.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/Premium/val_clean.jsonl"
...
# log settings
exp_name="premium_pretrain_remake"
