...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/premium_pretrain_remake/s2s_epoch_6_step_5955
split=test
...
speech_sample_rate=22050 #只对算时间有用 不是 这个非常重要
