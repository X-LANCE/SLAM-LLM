...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/premium_pretrain/s2s_epoch_6_step_14955
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/Emotion/secap_data/cosyvoice1_50HZ_token/test.jsonl
# # huggingface dataset
