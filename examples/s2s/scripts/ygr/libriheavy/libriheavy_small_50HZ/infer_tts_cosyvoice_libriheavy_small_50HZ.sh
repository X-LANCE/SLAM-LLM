...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/libriheavy_small_50HZ_tts_train-Qwen2-0.5b-gpu4-btz6-lr1e-4-fp16-epochs10-latency5-group3-maxsteps100000/s2s_epoch_10_step_3765
split=test
