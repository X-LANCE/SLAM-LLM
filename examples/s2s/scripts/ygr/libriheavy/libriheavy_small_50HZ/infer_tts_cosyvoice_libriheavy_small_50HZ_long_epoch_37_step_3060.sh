...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/libriheavy_small_50HZ_long_tts_train-Qwen2-0.5b-gpu4-btz6-lr1e-4-fp16-epochs100-latency5-group3-maxsteps400000/s2s_epoch_37_step_3060
split=test
