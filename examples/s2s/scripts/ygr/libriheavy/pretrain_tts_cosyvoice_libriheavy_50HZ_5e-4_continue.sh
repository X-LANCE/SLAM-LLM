...
train_data_path=/nfs/yangguanrou.ygr/data/libriheavy/cosyvoice_semantic_token_50HZ/train.jsonl
...
exp_name="tts_train_libriheavy_50HZ_5e-4"
# exp_name="debug"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/2024_11_21_22_11_40/tts_train_libriheavy_50HZ_5e-4/s2s_epoch_3_step_32520
...
++train_config.total_steps=400000 \
++train_config.lr=$lr \
