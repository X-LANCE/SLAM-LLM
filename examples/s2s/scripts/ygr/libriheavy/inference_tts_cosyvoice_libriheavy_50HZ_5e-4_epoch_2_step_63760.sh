...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/2024_11_21_22_11_40/tts_train_libriheavy_50HZ_5e-4/s2s_epoch_2_step_63760
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/libritts/cosyvoice_semantic_token_50HZ/dev-clean-first20.jsonl
