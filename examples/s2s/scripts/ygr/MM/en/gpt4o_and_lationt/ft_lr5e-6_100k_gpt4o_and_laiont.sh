...
# export WANDB_API_KEY=cc633438a8688eaf73ea5889022da2c394a92df2       # please replace with your own wandb key thxxxx, unless you want to share your experiment results with me :)
...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/MM/en/gpt4o_and_laiont/gpt4o_and_laiont.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/gpt4o_final_paper/val.jsonl"
...
# log settings
exp_name="ft_lr5e-6_100k_gpt4o_and_laiont"
...
home_dir=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/MM/en
# output_dir=$home_dir/$(TZ='Asia/Shanghai' date +"%Y_%m_%d")/$(TZ='Asia/Shanghai' date +"%H_%M_%S")
output_dir=$home_dir/$exp_name
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/VoiceAssistant_pretrain_align/s2s_epoch_5_step_13596  # this line is for resuming training
