...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/emobox_ft_simple_form_cwx_ckpt_reproduce_lr5e-6_100k/s2s_epoch_15_step_2640
split=test
