...
# log settings
exp_name="emobox_ft_simple_form_cwx_ckpt_reproduce_lr5e-6_100k"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/VoiceAssistant-400K-v2_reproduce/s2s_epoch_6_step_3495  # this line is for resuming training
