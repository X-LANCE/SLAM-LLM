...
# dataset settings
train_data_path="/nfs/yangguanrou.ygr/data/Emotion/all/cosyvoice_semantic_token_50HZ/train.jsonl"
val_data_path="/nfs/yangguanrou.ygr/data/Emotion/all/cosyvoice_semantic_token_50HZ/dev.jsonl"
...
# log settings
exp_name="tts_emotion_ft_simple_form_libritts_50HZ_wenxi_parameter_epoch_28_step_21_lr1e-5_all_emobox_lora_big"
...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/2024_12_14_17_07_23/tts_libritts_50HZ_wenxi_parameter/s2s_epoch_28_step_21  # this line is for resuming training
