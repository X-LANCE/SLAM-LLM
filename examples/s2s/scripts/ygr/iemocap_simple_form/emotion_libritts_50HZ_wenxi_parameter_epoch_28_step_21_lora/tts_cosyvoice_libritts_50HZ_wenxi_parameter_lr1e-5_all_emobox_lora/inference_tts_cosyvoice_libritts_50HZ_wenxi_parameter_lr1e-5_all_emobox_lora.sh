...
peft_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/2024_12_17_15_50_04/tts_emotion_ft_simple_form_libritts_50HZ_wenxi_parameter_epoch_28_step_21_lr1e-5_all_emobox_lora/s2s_epoch_8_step_1320
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/2024_12_14_17_07_23/tts_libritts_50HZ_wenxi_parameter/s2s_epoch_28_step_21
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/Emotion/all/cosyvoice_semantic_token_50HZ/dev_random_200.jsonl
# # huggingface dataset
...
decode_log=$peft_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_emobox_dev_random_200
if [ "$do_sample" = true ] ; then
    decode_log=$peft_path/s2s_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_sampling_topk${top_k}_topp${top_p}_temp${temperature}
fi
...
python examples/s2s/utils/eval_emo.py --pred $decode_log