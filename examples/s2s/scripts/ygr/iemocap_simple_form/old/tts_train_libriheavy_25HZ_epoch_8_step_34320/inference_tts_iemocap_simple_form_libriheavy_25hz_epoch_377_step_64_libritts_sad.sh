...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/iemocap_ft_simple_form/2024_12_05_12_07_44/tts_iemocap_ft_simple_form_libriheavy_25HZ_epoch_8_step_34320/s2s_epoch_377_step_64
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/libritts/cosyvoice_semantic_token/dev-clean-first20_sad.jsonl
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_sad
