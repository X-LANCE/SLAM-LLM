...
val_data_path=/nfs/yangguanrou.ygr/data/libritts/cosyvoice_semantic_token/dev-clean-first20_ang.jsonl
# # huggingface dataset
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_ang
