...
peft_ckpt=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/2024_12_17_15_50_04/tts_emotion_ft_simple_form_libritts_50HZ_wenxi_parameter_epoch_28_step_21_lr1e-5_all_emobox_lora/s2s_epoch_8_step_1320/model.pt
...
val_data_path=/nfs/yangguanrou.ygr/data/Emotion/all_part_old/cosyvoice_semantic_token_50HZ/dev_ang_20.jsonl
# # huggingface dataset
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_emodev_ang
