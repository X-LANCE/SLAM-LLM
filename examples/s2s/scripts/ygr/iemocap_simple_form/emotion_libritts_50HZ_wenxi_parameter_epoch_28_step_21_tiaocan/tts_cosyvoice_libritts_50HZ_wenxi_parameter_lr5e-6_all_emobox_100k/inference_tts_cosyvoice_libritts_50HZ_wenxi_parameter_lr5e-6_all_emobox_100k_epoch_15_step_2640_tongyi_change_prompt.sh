...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/iemocap_ft_simple_form/emotion_libritts_50HZ_wenxi_parameter_epoch_28_step_21_tiaocan/tts_emotion_ft_simple_form_libritts_50HZ_wenxi_parameter_epoch_28_step_21_lr5e-6_all_emobox_100k/s2s_epoch_15_step_2640
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/Emotion/all/cosyvoice_semantic_token_50HZ/dev_random_200_tongyi.jsonl
# # huggingface dataset
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_emobox_dev_random_200_tongyi_change_prompt
...
python $code_dir/inference_s2s.py \
        ...
        ++dataset_config.change_prompt=true \
