...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/tts_emotion_ft_simple_form_libritts_50HZ_wenxi_parameter_epoch_28_step_21_lr1e-5_all_emobox_50k/s2s_epoch_15_step_2640
split=test
