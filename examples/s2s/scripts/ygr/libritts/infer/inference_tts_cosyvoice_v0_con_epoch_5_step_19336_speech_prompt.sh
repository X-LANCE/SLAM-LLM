...
codec_decoder_path="/nfs/yangguanrou.ygr/ckpts/CosyVoice/CosyVoice-300M-25Hz"

tts_adapter=false
task_type=tts


ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/2024_11_19_18_36_15/tts_train_v0/s2s_epoch_5_step_19336
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/libritts/cosyvoice_semantic_token/dev-clean-first20.jsonl
...
audio_prompt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/prompt/prompt_3.wav     # replace this with your own audio prompt path or our provided audio prompt path


decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_audioprompt3
