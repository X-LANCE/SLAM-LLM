...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/libritts/25HZ/2024_12_12_20_02_47/tts_libritts_50HZ_wenxi_parameter_long/s2s_epoch_14_step_11899
split=test

# jsonl dataset
manifest_format=jsonl
val_data_path=/nfs/yangguanrou.ygr/data/libritts/cosyvoice_semantic_token_50HZ/dev-clean-first200.jsonl
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_dev-clean-first200
