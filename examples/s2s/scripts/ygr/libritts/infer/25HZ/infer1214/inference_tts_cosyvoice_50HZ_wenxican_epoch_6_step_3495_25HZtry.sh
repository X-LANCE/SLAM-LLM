...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/libritts/50HZ/2024_12_06_17_44_35/tts_libritts_50HZ_wenxi_parameter/s2s_epoch_6_step_3495
split=test
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_librittstest_25HZtry
