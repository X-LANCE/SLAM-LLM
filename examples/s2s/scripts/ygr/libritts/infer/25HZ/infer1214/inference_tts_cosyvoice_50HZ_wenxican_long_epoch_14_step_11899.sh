...
ckpt_path=/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/2024_12_12_20_02_47/tts_libritts_50HZ_wenxi_parameter_long/s2s_epoch_14_step_11899
split=test
...
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_librittstest
