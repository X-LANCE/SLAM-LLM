...
# log settings
exp_name="tts_libritts_50HZ_wenxi_parameter"
...
# 本来是/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/tts/tts_train-Qwen2-0.5b-gpu4-btz6-lr1e-4-fp16-epochs10-latency5-group3-maxsteps100000，改成/nfs/yangguanrou.ygr/codes/SLAM-LLM/examples/s2s/scripts/ygr/exp/libritts/50HZ/2024_12_06_17_44_35/tts_libritts_50HZ_wenxi_parameter
