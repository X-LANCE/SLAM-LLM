...
cosyvoice = CosyVoice2('/nfs/yangguanrou.ygr/ckpts/CosyVoice/CosyVoice2-0.5B', load_jit=False, load_trt=False, fp16=False)

json_file_path = '/nfs/yangguanrou.ygr/data/gpt4o_final_paper/test.jsonl'
# output_dir='/nfs/yangguanrou.ygr/data/MM/cosyvoice/2/prompt1/pred_audio/gt_tone'
# output_dir='/nfs/yangguanrou.ygr/data/MM/cosyvoice/2/prompt2/pred_audio/gt_tone'
# output_dir='/nfs/yangguanrou.ygr/data/MM/cosyvoice/2/prompt3/pred_audio/gt_tone'
output_dir='/nfs/yangguanrou.ygr/data/MM/cosyvoice/2/prompt4/pred_audio/gt_tone'
...
with open(json_file_path, 'r', encoding='utf-8') as json_file:
    for line in json_file:
        ...
        results = cosyvoice.inference_instruct2(text, instruct_str, prompt_speech_16k, stream=False)
        for i, output_chunk in enumerate(results):
            ...
            print(f"[cosy2]已保存: {out_wav_path}")

print("[cosy2] cosyvoice2所有语音已生成完毕！")
