...
for N in [100,500,1000,2000]:
    ...
    for ref_split in ["test_other"]:
        ...
        ctc_file="/root/fairseq/wavlm_ft_libri960_base10h_token/decode_result/ckptbest/test_other/viterbi/wavlm_ft_libri960_{}_tokentostr.txt".format(ref_split)  
        ...
        for index,data_dict in tqdm(enumerate(data_list)):
            ...
            high_score_items = [(k, value) for k, value in sorted_dict if value > 0.7] 
